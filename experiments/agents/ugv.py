...
class UgV(BaseActor):
    ...
    def __init__(self, config=None):
        ...
        self.target_pos = copy.deepcopy(self.init_pos)
        ...
        self.assigned_loc = None
        self.reached_loc = False
        self.payload = 5
        self.remaining_range = 10_000
    ...
    def load_asset(self):
        ...
        self.physics_client.changeVisualShape(self.object, -1, rgbaColor=[1, 0, 0, 1])
        return None
